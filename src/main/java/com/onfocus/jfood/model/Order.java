...
public class Order implements Serializable {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((changeValue == null) ? 0 : changeValue.hashCode());
		result = prime * result
		...
		result = prime * result
				+ ((receivedValue == null) ? 0 : receivedValue.hashCode());
		result = prime * result
				+ ((sObservacao == null) ? 0 : sObservacao.hashCode());
		result = prime * result
	...
	public String toString() {
		return "Order [id=" + id + ", changeValue=" + changeValue
				+ ", closeDate=" + closeDate + ", discount=" + discount
				+ ", idCustomer=" + idCustomer + ", idTable=" + idTable
				+ ", openDate=" + openDate + ", receivedValue=" + receivedValue
				+ ", sObservacao=" + sObservacao + ", totalValue=" + totalValue
				+ ", orderStatus=" + orderStatus + ", productType="
				+ productType + ", product=" + product + ", user=" + user + "]";
	}
