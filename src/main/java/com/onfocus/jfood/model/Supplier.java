...
public class Supplier implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((stateRegister == null) ? 0 : stateRegister.hashCode());
	...
	public String toString() {
		return "Supplier [id=" + id + ", address=" + address + ", cityRegister=" + cityRegister + ", cnpj=" + cnpj
				+ ", companyName=" + companyName + ", stateRegister=" + stateRegister + ", tradingName=" + tradingName
				+ ", invoices=" + invoices + "]";
	}
